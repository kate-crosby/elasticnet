# The straight script example of forest fires with 11 predictors in California from Tony Fischetti's example.

# The example could easily be adapted to any dataset with Yield or Yield-like
# predictors as response.

# NB in some of these examples plain ol' stepwise will outperform ridge, lasso, and elasticnets.
# Be sure to check.
